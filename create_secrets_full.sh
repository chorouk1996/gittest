...
function generateOrg1Secret(){
  ...
  oc create secret generic secret-blockchain-org1-solution2 \
	...
	--from-file=peerorg.orgdomain1.users.${USER1}.msp.cacerts.pem=${ROOTPATH_ORG1}/users/${USER1_UP}@${ORG1_DOMAIN}/msp/cacerts/ca.${ORG1_DOMAIN}-cert.pem \
	--from-file=peerorg.orgdomain1.users.${USER1}.msp.keystore.priv=${ROOTPATH_ORG1}/users/${USER1_UP}@${ORG1_DOMAIN}/msp/keystore/priv_sk \
	--from-file=peerorg.orgdomain1.users.${USER1}.msp.tlscacerts.pem=${ROOTPATH_ORG1}/users/${USER1_UP}@${ORG1_DOMAIN}/msp/tlscacerts/tlsca.${ORG1_DOMAIN}-cert.pem \
	--from-file=peerorg.orgdomain1.users.${USER1}.tls.cacrt=${ROOTPATH_ORG1}/users/${USER1_UP}@${ORG1_DOMAIN}/tls/ca.crt \
	--from-file=peerorg.orgdomain1.users.${USER1}.tls.clientcrt=${ROOTPATH_ORG1}/users/${USER1_UP}@${ORG1_DOMAIN}/tls/client.crt \
...
function generateOrg2Secret(){
  ...
  oc create secret generic secret-blockchain-org2-solution2 \
	--from-file=peerorg.orgdomain2.msp.admincerts=${ROOTPATH_ORG2}/users/Admin@${ORG2_DOMAIN}/msp/signcerts/Admin@${ORG2_DOMAIN}-cert.pem \
	--from-file=peerorg.orgdomain2.peers.${PEER2}.msp.admincerts=${ROOTPATH_ORG2}/users/Admin@${ORG2_DOMAIN}/msp/signcerts/Admin@${ORG2_DOMAIN}-cert.pem \
	...
	--from-file=peerorg.orgdomain2.tlsca.pem=${ROOTPATH_ORG2}/tlsca/tlsca.${ORG2_DOMAIN}-cert.pem \
	--from-file=peerorg.orgdomain2.msp.cacerts.pem=${ROOTPATH_ORG2}/msp/cacerts/ca.${ORG2_DOMAIN}-cert.pem \
	...
	--from-file=peerorg.orgdomain2.users.admin.msp.cacerts.pem=${ROOTPATH_ORG2}/users/Admin@${ORG2_DOMAIN}/msp/cacerts/ca.${ORG2_DOMAIN}-cert.pem \
	--from-file=peerorg.orgdomain2.users.admin.msp.keystore.priv=${ROOTPATH_ORG2}/users/Admin@${ORG2_DOMAIN}/msp/keystore/priv_sk \
	--from-file=peerorg.orgdomain2.users.admin.msp.tlscacerts.pem=${ROOTPATH_ORG2}/users/Admin@${ORG2_DOMAIN}/msp/tlscacerts/tlsca.${ORG2_DOMAIN}-cert.pem \
	--from-file=peerorg.orgdomain2.users.admin.tls.cacrt=${ROOTPATH_ORG2}/users/Admin@${ORG2_DOMAIN}/tls/ca.crt \
	--from-file=peerorg.orgdomain2.users.admin.tls.clientcrt=${ROOTPATH_ORG2}/users/Admin@${ORG2_DOMAIN}/tls/client.crt \
	--from-file=peerorg.orgdomain2.users.admin.tls.clientkey=${ROOTPATH_ORG2}/users/Admin@${ORG2_DOMAIN}/tls/client.key \
	--from-file=peerorg.orgdomain2.users.${USER1}.msp.cacerts.pem=${ROOTPATH_ORG2}/users/${USER1_UP}@${ORG2_DOMAIN}/msp/cacerts/ca.${ORG2_DOMAIN}-cert.pem \
	--from-file=peerorg.orgdomain2.users.${USER1}.msp.keystore.priv=${ROOTPATH_ORG2}/users/${USER1_UP}@${ORG2_DOMAIN}/msp/keystore/priv_sk \
	--from-file=peerorg.orgdomain2.users.${USER1}.msp.tlscacerts.pem=${ROOTPATH_ORG2}/users/${USER1_UP}@${ORG2_DOMAIN}/msp/tlscacerts/tlsca.${ORG2_DOMAIN}-cert.pem \
	--from-file=peerorg.orgdomain2.users.${USER1}.tls.cacrt=${ROOTPATH_ORG2}/users/${USER1_UP}@${ORG2_DOMAIN}/tls/ca.crt \
	--from-file=peerorg.orgdomain2.users.${USER1}.tls.clientcrt=${ROOTPATH_ORG2}/users/${USER1_UP}@${ORG2_DOMAIN}/tls/client.crt \
